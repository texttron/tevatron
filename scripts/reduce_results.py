...
parser = argparse.ArgumentParser(
    description="Reduce retrieval results from multiple shards."
)
parser.add_argument(
    "--results_dir",
    type=str,
    help="Directory that contains results from all shards",
    required=True,
)
...
parser.add_argument(
    "--depth",
    type=int,
    help="Number of retrieved doc for each query",
    required=False,
    default=100,
)
