...
from tevatron.distillation.data import (
    DistilTrainDataset,
    DistilTrainCollator,
    HFDistilTrainDataset,
)
from tevatron.distillation.trainer import DistilTrainer
from tevatron.distillation.arguments import (
    DistilModelArguments,
    DistilTrainingArguments,
)
...
def main():
    parser = HfArgumentParser(
        (DistilModelArguments, DataArguments, DistilTrainingArguments)
    )
    ...
    teacher_config = AutoConfig.from_pretrained(
        (
            ...
            if model_args.teacher_config_name
    ...
    train_dataset = DistilTrainDataset(
        data_args, train_dataset.process(), tokenizer, teacher_tokenizer
    )
    if training_args.local_rank == 0:
